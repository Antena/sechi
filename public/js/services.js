...
services.factory('Settlement', function() {
    return [
            {name:"Comuna 1 y 2",barrios:['Villa 31','Villa 31 Bis']},
            {name:"Comuna 4",barrios:['Villa 21-24','CH Espora','NHT Zabaleta',]},
            {name:"Comuna 8 norte",barrios:['Barrio Piletones','Barrio Fátima','Calaza','Calacita','Barrio Carrillo','CH Soldati','CH Lacarra','CH Cruz y Lacarra','CH Portela','A. Los Pinos','A. La Esperanza','A. La Paloma','A. AU 7',]},
            {name:"Comuna 8 sur",barrios:['Villa 20','Villa 16','CH Lugano I y II','CH Savio I y II','CH Parque de las Victorias']},
            {name:"Comuna 8 y 9 oeste",barrios:['Villa 15 (Ciudad Oculta)','CH Piedrabuena','CH Padre Mugica','CH M. Dorrego','NHT del Trabajo','Barrio Pirelli','Barrio INTA','A. Scapino','A. Bermejo','A. San Pablo','A. Barrio Obrero','A. María Auxiliadora',]},
            {name:"Comuna 8 y 9 este",barrios:['Barrio Cildáñez','CH Nágera','CH Samoró','CH Castro','CH Copello']},
            {name:"Comuna 7",barrios:['Villa 1-11-14','Villa 13 Bis','CH Rivadavia I y II','CH Illia','Barrio Charrúa (Gral. San Martín)']}
          ]
})
